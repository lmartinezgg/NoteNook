 ...
 * This file demonstrates how to integrate Notenook with a web frontend
 */

// For React/Vue/Angular applications
export class NotenookClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new NotenookClient(provider, contractAddress);
